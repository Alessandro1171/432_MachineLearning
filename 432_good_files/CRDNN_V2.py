    ...
    def __init__(
        ...
        self.crdnn_module1.add_module(
            ...
            sb.nnet.CNN.Conv2d(
                ...
                padding="valid",
                bias=False,
                max_norm=float(crdnn_spatial_max_norm),
                swap=True,
            ),
        )
        ...
        print("yyyyyyyyy",((1,) + tuple(input_shape[1:-1]) + (1,)),"yyyyy")
        self.crdnn_module1.add_module("dropout_0", torch.nn.Dropout(p=dropout))
        hidden_size1 = (
            int(crdnn_spatial_kernels * lstm_multiplier1)
        )
      
        self.crdnn_module1.add_module(
            "RNN_1",
            sb.nnet.RNN.LSTM(
                input_shape=[1, 125, 1, crdnn_spatial_kernels],
                num_layers=lstm_shape1,
        ...
        self.crdnn_module2.add_module(
            "RNN_2",
            sb.nnet.RNN.LSTM(
                input_shape=[1, 125, 1, hidden_size1],
                num_layers=lstm_shape2,
